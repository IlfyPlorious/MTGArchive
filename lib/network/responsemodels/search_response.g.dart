...
SearchResponse _$SearchResponseFromJson(Map<String, dynamic> json) =>
    SearchResponse(
      data: (json['data'] as List<dynamic>?)
          ?.map((e) => ScryfallCard.fromJson(e as Map<String, dynamic>))
          .toList(),
      object: json['object'] as String?,
      totalCards: json['total_cards'] as int?,
      nextPageLink: json['next_page'] as String?,
    );
...
Map<String, dynamic> _$SearchResponseToJson(SearchResponse instance) =>
    <String, dynamic>{
      ...
      'next_page': instance.nextPageLink,
    };

ScryfallCard _$ScryfallCardFromJson(Map<String, dynamic> json) => ScryfallCard(
      object: json['object'] as String?,
...
Map<String, dynamic> _$ScryfallCardToJson(ScryfallCard instance) =>
    <String, dynamic>{
      'object': instance.object,
      'id': instance.id,
